...
plain_html_text = requests.get(url_to_scrape).text
#parse the data
soup = BeautifulSoup(plain_html_text, 'html.parser')

#print whole html data to screen
# print(soup.prettify())
...
for article in articles:
    ...
    #TODO: fix funky letter formatting thats happening
    
    ## print category
    if (len(article.find_all("p", class_ = "category")) == 1):
        print(article.find_all("p", class_ = "category")[0].get_text())

    ## print article description 
    if (len(article.find_all("p", class_ = "subhead")) == 1):
        print(article.find_all("p", class_ = "subhead")[0].string)

    ## print article title
    print(article.h3.string)

    ## print article link
    print(article.h3.a.get('href'))

    ## Start to printing authors (not completed)
    print(article.footer.a.string)
